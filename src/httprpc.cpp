...
static bool InitRPCAuthentication()
{
    ...
    g_rpc_whitelist_default = RpcwhitelistdefaultSetting::Get(gArgs);
    for (const std::string& strRPCWhitelist : RpcwhitelistSetting::Get(gArgs).value_or(std::vector<std::string>{})) {
