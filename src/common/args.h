...
public:
     ...
     * accomodate parsing command lines and configuration files written by human
     * beings, not just machines, understanding that users may have different
     * configuration styles and debugging needs. So the flags do not mandate one
     * way to configure things or try to prevent every possible error, but
     * instead catch the most common and blatant errors, and allow application
     * code to impose additional restrictions, since application code needs to
     * parse settings and reject invalid values anyway.
     *
