...
struct Setting {
    ...
    {
        internal::SettingRegister<summary, help, T, category, options, help_fn, default_fn, get_fn>(manager, register_options...);
    }
    ...
    using Default = Setting<summary, T, options, help, help_fn, +[] { return _default; }, get_fn, category>;
