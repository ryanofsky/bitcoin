...
struct SettingTraits<bool, options> : SettingTraitsBase<bool>
{
    ...
    static void Update(Unset, setting_t& out) { out = {}; }
...
template<typename Traits, SettingOptions options, size_t index, typename... Types>
struct VariantTraits;

template<SettingOptions options, int index, typename Type>
struct VariantTraits<void, options, index, Type>
{
    using merged_t = SettingTraits<Type, options>;
...
template<typename Traits, SettingOptions options, int index, typename Type>
struct VariantTraits<Traits, options, index, Type>
{
    ...
    struct merged_t {
        ...
        static constexpr bool has_unset = cur_t::has_unset || Type::has_unset;
    ...
    static constexpr int index_unset{cur_t::has_unset ? Traits::index_unset : index};
...
template<typename Traits, SettingOptions options, int index, typename Type1, typename Type2, typename... Rest>
struct VariantTraits<Traits, options, index, Type1, Type2, Rest...> : VariantTraits<VariantTraits<Traits, options, index, Type1>, options, index + 1, Type2, Rest...> {
};

template<typename... T, SettingOptions options>
struct SettingTraits<std::variant<T...>, options> : VariantTraits<void, options, 0, T...>::merged_t
{
    using setting_t = std::variant<T...>;
    using variant_t = VariantTraits<void, options, 0, T...>;
