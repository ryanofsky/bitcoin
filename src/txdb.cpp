...
CCoinsViewDB::CCoinsViewDB(DBParams db_params, CoinsViewOptions options, BCLog::Logger& logger) :
    m_db_params{std::move(db_params)},
    m_options{std::move(options)},
    m_log{logger, BCLog::COINDB},
    m_db{std::make_unique<CDBWrapper>(m_db_params, logger)} { }
...
void CCoinsViewDB::ResizeCache(size_t new_cache_size)
{
    ...
    if (!m_db_params.memory_only) {
        ...
        m_db = std::make_unique<CDBWrapper>(m_db_params, m_log.logger);
    }
}
