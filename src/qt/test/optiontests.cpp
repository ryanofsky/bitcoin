...
void OptionTests::parametersInteraction()
{
    ...
    QVERIFY(!ListenSetting::Get(gArgs));
    QVERIFY(!ListenonionSetting::Get(gArgs));
    ...
    QVERIFY(ListenSetting::Get(gArgs));
    QCOMPARE(ListenSetting::Get(gArgs).value_or(!expected), expected);

    QVERIFY(ListenonionSetting::Get(gArgs));
    QCOMPARE(ListenonionSetting::Get(gArgs).value_or(!expected), expected);
