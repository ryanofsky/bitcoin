...
<<<<<<< HEAD
||||||| parent of 79a970d4f124 (refactor: Use util::Result class in LoadChainstate and VerifyLoadedChainstate)
...
using kernel::LoadMempool;
using kernel::ValidationCacheSizes;
>>>>>>> 79a970d4f124 (refactor: Use util::Result class in LoadChainstate and VerifyLoadedChainstate)
