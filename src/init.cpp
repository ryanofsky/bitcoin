...
||||||| parent of 93af79a1aae9 (refactor: Use util::Result class in LoadChainstate and VerifyLoadedChainstate)
                LogPrintf("%s\n", e.what());
                return std::make_tuple(node::ChainstateLoadStatus::FAILURE, _("Error opening block database"));
=======
                LogPrintf("%s\n", e.what());
                return {util::Error{_("Error opening block database")}, node::ChainstateLoadError::FAILURE};
>>>>>>> 93af79a1aae9 (refactor: Use util::Result class in LoadChainstate and VerifyLoadedChainstate)
            }
        };
