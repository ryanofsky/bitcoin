...
||||||| parent of d0d2535cac1 (refactor: Use util::Result class in LoadChainstate and VerifyLoadedChainstate)

=======
using kernel::InterruptResult;
>>>>>>> d0d2535cac1 (refactor: Use util::Result class in LoadChainstate and VerifyLoadedChainstate)
