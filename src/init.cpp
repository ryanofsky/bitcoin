...
||||||| parent of 48949d1c601b (refactor: Use util::Result class in LoadChainstate and VerifyLoadedChainstate)
        bool do_retry = uiInterface.ThreadSafeQuestion(
=======
        const auto& error = util::ErrorString(result);
        bool do_retry = uiInterface.ThreadSafeQuestion(
>>>>>>> 48949d1c601b (refactor: Use util::Result class in LoadChainstate and VerifyLoadedChainstate)
