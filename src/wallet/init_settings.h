...
using WalletSetting = common::Setting<
    "-wallet=<path>", std::vector<std::string>, {.legacy = true, .network_only = true},
...
using ConsolidatefeerateSetting = common::Setting<
    "-consolidatefeerate=<amt>", std::string, {.legacy = true},
...
using DiscardfeeSetting = common::Setting<
    "-discardfee=<amt>", std::string, {.legacy = true},
...
using FallbackfeeSetting = common::Setting<
    "-fallbackfee=<amt>", std::string, {.legacy = true},
...
using MaxapsfeeSetting = common::Setting<
    "-maxapsfee=<n>", std::string, {.legacy = true},
...
using MaxtxfeeSetting = common::Setting<
    "-maxtxfee=<amt>", std::string, {.legacy = true},
...
using MintxfeeSetting = common::Setting<
    "-mintxfee=<amt>", std::string, {.legacy = true},
...
using PaytxfeeSetting = common::Setting<
    "-paytxfee=<amt>", std::string, {.legacy = true},
...
using WalletdirSetting = common::Setting<
    "-walletdir=<dir>", fs::path, {.legacy = true, .network_only = true},
