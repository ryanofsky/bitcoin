#ifndef WALLET_INIT_SETTINGS_H
#define WALLET_INIT_SETTINGS_H
...
using WalletSetting = common::Setting<
    "-wallet=<path>", std::optional<std::vector<std::string>>, {.legacy = true, .network_only = true},
...
using WalletSettingStr = common::Setting<
    "-wallet=<path>", std::optional<std::string>, {.legacy = true, .network_only = true}>
    ::Category<OptionsCategory::WALLET>;

using SignerSetting = common::Setting<
    "-signer=<cmd>", std::string, {.legacy = true},
    "External signing tool, see doc/external-signer.md">
    ::Category<OptionsCategory::WALLET>;

using DisablewalletSetting = common::Setting<
    "-disablewallet", bool, {.legacy = true},
...
using AvoidpartialspendsSetting = common::Setting<
    "-avoidpartialspends", bool, {.legacy = true},
...
using UnsafesqlitesyncSetting = common::Setting<
    "-unsafesqlitesync", std::optional<bool>, {.legacy = true, .debug_only = true},
...
using PrivdbSetting = common::Setting<
    "-privdb", std::optional<bool>, {.legacy = true, .debug_only = true},
...
using DblogsizeSetting = common::Setting<
    "-dblogsize=<n>", std::optional<int64_t>, {.legacy = true, .debug_only = true},
...
using AddresstypeSetting = common::Setting<
    "-addresstype", std::string, {.legacy = true},
...
using ChangetypeSetting = common::Setting<
    "-changetype", std::string, {.legacy = true},
...
using ConsolidatefeerateSetting = common::Setting<
    "-consolidatefeerate=<amt>", std::optional<std::string>, {.legacy = true},
...
using DiscardfeeSetting = common::Setting<
    "-discardfee=<amt>", std::optional<std::string>, {.legacy = true},
...
using FallbackfeeSetting = common::Setting<
    "-fallbackfee=<amt>", std::optional<std::string>, {.legacy = true},
...
using MaxapsfeeSetting = common::Setting<
    "-maxapsfee=<n>", std::optional<std::string>, {.legacy = true},
...
using MaxtxfeeSetting = common::Setting<
    "-maxtxfee=<amt>", std::optional<std::string>, {.legacy = true},
...
using MintxfeeSetting = common::Setting<
    "-mintxfee=<amt>", std::optional<std::string>, {.legacy = true},
...
using PaytxfeeSetting = common::Setting<
    "-paytxfee=<amt>", std::optional<std::string>, {.legacy = true},
...
using SpendzeroconfchangeSetting = common::Setting<
    "-spendzeroconfchange", bool, {.legacy = true},
...
using TxconfirmtargetSetting = common::Setting<
    "-txconfirmtarget=<n>", int64_t, {.legacy = true},
...
using WalletnotifySetting = common::Setting<
    "-walletnotify=<cmd>", std::string, {.legacy = true},
