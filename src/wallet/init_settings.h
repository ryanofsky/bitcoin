...
using WalletSettingStr = common::Setting<
    "-wallet=<path>", std::string, {.legacy = true, .network_only = true}>
    ::Category<OptionsCategory::WALLET>;
...
using UnsafesqlitesyncSetting = common::Setting<
    "-unsafesqlitesync", bool, {.legacy = true, .debug_only = true},
...
using PrivdbSetting = common::Setting<
    "-privdb", bool, {.legacy = true, .debug_only = true},
...
using DblogsizeSetting = common::Setting<
    "-dblogsize=<n>", int64_t, {.legacy = true, .debug_only = true},
