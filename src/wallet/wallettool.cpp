...
bool ExecuteWalletToolFunc(const ArgsManager& args, const std::string& command)
{
    ...
    if (command == "create") {
        ...
        wallet_instance->Close();
<<<<<<< HEAD
||||||| parent of 9149f7313359 (refactor: Use util::Result class in wallet/salvage)
...
=======
        ...
        return false;
#endif
>>>>>>> 9149f7313359 (refactor: Use util::Result class in wallet/salvage)
...
||||||| parent of f7aca5fd1d24 (refactor: Use util::Result class in wallet/wallettool)
        DatabaseStatus status;

        if (args.GetBoolArg("-withinternalbdb", false) && IsBDBFile(BDBDataFile(path))) {
=======
        if (args.GetBoolArg("-withinternalbdb", false) && IsBDBFile(BDBDataFile(path))) {
>>>>>>> f7aca5fd1d24 (refactor: Use util::Result class in wallet/wallettool)
