...
bool ExecuteWalletToolFunc(const ArgsManager& args, const std::string& command)
{
    ...
    if (command == "create") {
        ...
        bool make_legacy = LegacySetting::Get(args, false);
        // If neither -legacy nor -descriptors is set, default to true. If -descriptors is set, use its value.
        bool make_descriptors = (!DescriptorsSetting::Get(args) && !LegacySetting::Get(args)) || (DescriptorsSetting::Get(args) && DescriptorsSetting::Get(args, true));
