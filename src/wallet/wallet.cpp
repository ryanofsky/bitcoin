...
||||||| parent of 676335de491e (refactor: Use util::Result class in wallet/wallet)
...
>>>>>>> 676335de491e (refactor: Use util::Result class in wallet/wallet)
||||||| parent of 089c58f5b0fa (scripted-diff: replace wallet DatabaseStatus with DatabaseError)
util::ResultPtr<std::unique_ptr<WalletDatabase>, DatabaseStatus> MakeWalletDatabase(const std::string& name, const DatabaseOptions& options)
=======
...
>>>>>>> 089c58f5b0fa (scripted-diff: replace wallet DatabaseStatus with DatabaseError)
{
...
||||||| parent of 8703a07ba277 (refactor: Use util::Result class in wallet::MakeDatabase)
    return MakeDatabase(wallet_path, options, status, error_string);
=======
    return ResultExtract(MakeDatabase(wallet_path, options), &status, &error_string);
>>>>>>> 8703a07ba277 (refactor: Use util::Result class in wallet::MakeDatabase)
||||||| parent of 676335de491e (refactor: Use util::Result class in wallet/wallet)
    return ResultExtract(MakeDatabase(wallet_path, options), &status, &error_string);
=======
