...
=======
std::shared_ptr<CWallet> LoadWalletInternal(WalletContext& context, const std::string& name, Optional<bool> load_on_start, const DatabaseOptions& options, DatabaseStatus& status, bilingual_str& error, std::vector<bilingual_str>& warnings)
>>>>>>> refactor: remove ::vpwallets and related global variables
{
    try {
...
=======
std::shared_ptr<CWallet> LoadWallet(WalletContext& context, const std::string& name, Optional<bool> load_on_start, const DatabaseOptions& options, DatabaseStatus& status, bilingual_str& error, std::vector<bilingual_str>& warnings)
>>>>>>> refactor: remove ::vpwallets and related global variables
{
...
=======
std::shared_ptr<CWallet> CreateWallet(WalletContext& context, const std::string& name, Optional<bool> load_on_start, const DatabaseOptions& options, DatabaseStatus& status, bilingual_str& error, std::vector<bilingual_str>& warnings)
>>>>>>> refactor: remove ::vpwallets and related global variables
{
