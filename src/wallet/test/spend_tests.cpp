...
BOOST_FIXTURE_TEST_CASE(SubtractFee, TestChain100Setup)
{
    ...
    // be uneconomical to add and spend a transaction output), and make sure it
    // pays the leftover input amount which would have been change to the
    // recipient instead of the miner.
