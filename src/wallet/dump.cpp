...
||||||| parent of 91659baacd7b (refactor: Use util::Result class in wallet/dump)
    uint32_t ver;
...
=======
    uint32_t ver;
    if (!ParseUInt32(version_value, &ver)) {
>>>>>>> 91659baacd7b (refactor: Use util::Result class in wallet/dump)
        dump_file.close();
...
||||||| parent of 84989196bc89 (refactor: Use util::Result class in wallet::MakeDatabase)
...
>>>>>>> 84989196bc89 (refactor: Use util::Result class in wallet::MakeDatabase)
