...
||||||| parent of c0946252d9d1 (refactor: Use util::Result class in wallet/wallet)
        RemoveWallet(context, wallet, /* load_on_start= */ std::nullopt, warnings);
        UnloadWallet(std::move(wallet));
=======
        ResultExtract(RemoveWallet(context, wallet, /* load_on_start= */ std::nullopt), nullptr, nullptr, &warnings);
||||||| parent of 5a061701d2fe (refactor: Use util::Result class in wallet/load)
        std::vector<bilingual_str> warnings;
        ResultExtract(RemoveWallet(context, wallet, /* load_on_start= */ std::nullopt), nullptr, nullptr, &warnings);
=======
        // Note: Warnings returned from RemoveWallet are silently discarded.
        RemoveWallet(context, wallet, /* load_on_start= */ std::nullopt);
>>>>>>> 5a061701d2fe (refactor: Use util::Result class in wallet/load)
        UnloadWallet(std::move(wallet));
>>>>>>> c0946252d9d1 (refactor: Use util::Result class in wallet/wallet)
    }
}
} // namespace wallet
