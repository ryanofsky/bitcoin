...
void ReadDatabaseArgs(const ArgsManager& args, DatabaseOptions& options)
{
    ...
    options.use_unsafe_sync = UnsafesqlitesyncSetting::Get(args).value_or(options.use_unsafe_sync);
    options.use_shared_memory = !PrivdbSetting::Get(args).value_or(!options.use_shared_memory);
    options.max_log_mb = DblogsizeSetting::Get(args).value_or(options.max_log_mb);
}
