...
public:
    ...
    virtual const CKeyMetadata* GetMetadata(const CScript& scriptPubKey, const CKeyID* key_id = nullptr) const { return nullptr; }
};
...
public:
    ...
    const CKeyMetadata* GetMetadata(const CScript& scriptPubKey, const CKeyID* key_id = nullptr) const override;
