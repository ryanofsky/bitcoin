...
||||||| parent of cc095e72d04a (refactor, validation: Return fatal errors from block connect functions)
...
=======
                    ...
                    result.Update(util::Error{std::move(error)});
                    return result;
>>>>>>> cc095e72d04a (refactor, validation: Return fatal errors from block connect functions)
                }
            }
        }
    }
...
||||||| parent of 067a5e90cdc5 (refactor, validation: Return fatal errors from assumeutxo snapshot functions)
bool ChainstateManager::ValidatedSnapshotCleanup()
=======
util::Result<void, AbortFailure> ChainstateManager::ValidatedSnapshotCleanup()
>>>>>>> 067a5e90cdc5 (refactor, validation: Return fatal errors from assumeutxo snapshot functions)
{
    AssertLockHeld(::cs_main);
