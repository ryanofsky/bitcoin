...
||||||| parent of 1120f03f8aaa (refactor, blockstorage: Return FlushResult from flush methods)
                if (!m_blockman.FlushChainstateBlockFile(m_chain.Height())) {
...
>>>>>>> 1120f03f8aaa (refactor, blockstorage: Return FlushResult from flush methods)
                }
            }
...
||||||| parent of ac6278f88983 (refactor, validation: Return fatal errors from FlushStateToDisk)
    if (!this->FlushStateToDisk(state, FlushStateMode::ALWAYS)) {
...
=======
    if (!(this->FlushStateToDisk(state, FlushStateMode::ALWAYS) >> result)) {
        ...
        LogPrintf("%s: %s\n", __func__, error.original);
        result.Update(util::Error{std::move(error)});
>>>>>>> ac6278f88983 (refactor, validation: Return fatal errors from FlushStateToDisk)
    }
    return result;
}
...
<<<<<<< HEAD
        ...
        return false;
||||||| parent of c0fe72e57a96 (refactor, validation: Return fatal errors from activate best chain functions)
...
=======
        ...
        result.Update(util::Error{std::move(error)});
        return result;
>>>>>>> c0fe72e57a96 (refactor, validation: Return fatal errors from activate best chain functions)
    }
...
||||||| parent of aa57da149017 (refactor, validation: Return more errors from VerifyDB)
...
=======
            ...
            result.Update(util::Error{std::move(error)});
            return result;
>>>>>>> aa57da149017 (refactor, validation: Return more errors from VerifyDB)
        }
...
||||||| parent of dcb05f457fc6 (refactor, validation: Return fatal errors from block connect functions)
            if (!chainstate.ConnectBlock(block, state, pindex, coins)) {
...
<<<<<<< HEAD
                LogPrintf("Verification error: found unconnectable block at %d, hash=%s (%s)\n", pindex->nHeight, pindex->GetBlockHash().ToString(), state.ToString());
>>>>>>> dcb05f457fc6 (refactor, validation: Return fatal errors from block connect functions)
                return VerifyDBResult::CORRUPTED_BLOCK_DB;
||||||| parent of aa57da149017 (refactor, validation: Return more errors from VerifyDB)
                LogPrintf("Verification error: found unconnectable block at %d, hash=%s (%s)\n", pindex->nHeight, pindex->GetBlockHash().ToString(), state.ToString());
                return VerifyDBResult::CORRUPTED_BLOCK_DB;
...
<<<<<<< HEAD
        ...
        return false;
||||||| parent of a8b418181e07 (refactor, validation: Return fatal errors from assumeutxo snapshot functions)
...
=======
        ...
        result.Update(util::Error{});
        return result;
>>>>>>> a8b418181e07 (refactor, validation: Return fatal errors from assumeutxo snapshot functions)
    }
