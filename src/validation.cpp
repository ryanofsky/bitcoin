...
||||||| parent of 57b1f09b300e (refactor, validation: Switch to result.Update)
...
>>>>>>> 57b1f09b300e (refactor, validation: Switch to result.Update)
...
>>>>>>> 57b1f09b300e (refactor, validation: Switch to result.Update)
    ...
    if (auto res{this->PopulateAndValidateSnapshot(*snapshot_chainstate, coins_file, metadata) >> result}; !res) {
        LOCK(::cs_main);
