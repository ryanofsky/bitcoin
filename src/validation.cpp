                                         ...
                                         PackageValidationState& package_state)
{
    ...
    const BCLog::Context& log_packages{BCLog::TXPACKAGES, m_pool.m_log.logger};
                               ...
                               CCoinsViewCache& view, bool fJustCheck)
{
    ...
    const BCLog::Context log_bench{BCLog::BENCH, m_log.logger};
    ...
    int nManualPruneHeight)
{
    ...
    const BCLog::Context log_prune{BCLog::PRUNE, m_log.logger};
    ...
    std::multimap<uint256, FlatFilePos>* blocks_with_unknown_parent)
{
    ...
    const BCLog::Context log_reindex{BCLog::REINDEX, m_log.logger};
