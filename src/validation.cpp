...
||||||| parent of dbd3b6f98aa (refactor, validation: Return fatal errors from FlushStateToDisk)
...
<<<<<<< HEAD
        ...
        if (!ret) return false;
||||||| parent of 1d6ea5fb6a6 (refactor, blockstorage: Return fatal error from LoadBlockIndex)
        bool ret{m_blockman.LoadBlockIndexDB(SnapshotBlockhash())};
        if (!ret) return false;
=======
        result.update(m_blockman.LoadBlockIndexDB(SnapshotBlockhash()));
        if (!result || IsInterrupted(*result)) return result;
>>>>>>> 1d6ea5fb6a6 (refactor, blockstorage: Return fatal error from LoadBlockIndex)
...
<<<<<<< HEAD
||||||| parent of b1cae2ab090 (refactor, validation: Switch to result.Update)
...
>>>>>>> b1cae2ab090 (refactor, validation: Switch to result.Update)
