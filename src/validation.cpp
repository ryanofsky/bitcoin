...
// necessary (before d43a1f1a2fa3) to avoid advancing the background validation
// chainstate farther than the snapshot base block. Now it would be possible to
// avoid this, but simply releasing cs_main here would not be possible because
// this function is invoked by ConnectTip within ActivateBestChain.
//
