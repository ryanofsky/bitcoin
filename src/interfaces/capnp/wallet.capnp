...
interface Wallet $Proxy.wrap("interfaces::Wallet") {
    ...
    createTransaction @26 (context :Proxy.Context, recipients :List(Recipient), coinControl :CoinControl, sign :Bool, changePos :Int32) -> (changePos :Int32, fee :Int64, failReason :Text, result :Data);
    ...
    fillPSBT @40 (context :Proxy.Context, sighashType :Int32, sign :Bool, bip32derivs :Bool) -> (psbt :Data, complete :Bool, result :Int32);
