...
interface Wallet $Proxy.wrap("interfaces::Wallet") {
    ...
    commitTransaction @28 (context :Proxy.Context, tx :Data, valueMap :List(Common.Pair(Text, Text)), orderForm :List(Common.Pair(Text, Text))) -> ();
    ...
    fillPSBT @41 (context :Proxy.Context, sighashType :Int32, sign :Bool, bip32derivs :Bool) -> (psbt :Data, complete :Bool, result :Int32);
    tryGetBalances @42 (context :Proxy.Context) -> (balances :WalletBalances, numBlocks :Int32, result :Bool);
    getBalance @43 (context :Proxy.Context) -> (result :Int64);
    getAvailableBalance @44 (context :Proxy.Context, coinControl :CoinControl) -> (result :Int64);
    txinIsMine @45 (context :Proxy.Context, txin :Data) -> (result :Int32);
    txoutIsMine @46 (context :Proxy.Context, txout :Data) -> (result :Int32);
    getDebit @47 (context :Proxy.Context, txin :Data, filter :Int32) -> (result :Int64);
    getCredit @48 (context :Proxy.Context, txout :Data, filter :Int32) -> (result :Int64);
    listCoins @49 (context :Proxy.Context) -> (result :List(Common.Pair(TxDestination, List(Common.Pair(Data, WalletTxOut)))));
    getCoins @50 (context :Proxy.Context, outputs :List(Data)) -> (result :List(WalletTxOut));
    getRequiredFee @51 (context :Proxy.Context, txBytes :UInt32) -> (result :Int64);
    getMinimumFee @52 (context :Proxy.Context, txBytes :UInt32, coinControl :CoinControl, wantReturnedTarget :Bool, wantReason :Bool) -> (returnedTarget :Int32, reason :Int32, result :Int64);
    getConfirmTarget @53 (context :Proxy.Context) -> (result :UInt32);
    hdEnabled @54 (context :Proxy.Context) -> (result :Bool);
    canGetAddresses @55 (context :Proxy.Context) -> (result :Bool);
    privateKeysDisabled @56 (context :Proxy.Context) -> (result :Bool);
    getDefaultAddressType @57 (context :Proxy.Context) -> (result :Int32);
    getDefaultChangeType @58 (context :Proxy.Context) -> (result :Int32);
