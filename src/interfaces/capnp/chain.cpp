...
void ProxyClientCustom<interfaces::capnp::messages::ChainNotifications,
    ...
    const std::vector<CTransactionRef>& tx_conflicted, int height)
{
    self().blockConnected(block, tx_conflicted, height);
}
void ProxyClientCustom<interfaces::capnp::messages::ChainNotifications,
    interfaces::Chain::Notifications>::BlockDisconnected(const CBlock& block, int height)
{
    self().blockDisconnected(block, height);
}
void ProxyClientCustom<interfaces::capnp::messages::ChainNotifications,
