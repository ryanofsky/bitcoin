...
interface Node $Proxy.wrap("interfaces::Node") {
    ...
    loadWallet @46 (context :Proxy.Context, name :Text) -> (error :Common.BilingualStr, warning :List(Common.BilingualStr), result :Wallet.Wallet);
    createWallet @47 (context :Proxy.Context, passphrase :Text, flags :UInt64, name :Text) -> (error :Common.BilingualStr, warning :List(Common.BilingualStr), status: Int32, result :Wallet.Wallet);
