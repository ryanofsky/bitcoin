...
interface ChainNotifications $Proxy.wrap("interfaces::Chain::Notifications") {
    ...
    blockConnected @3 (context :Proxy.Context, block :Data, txConflicted :List(Data), height :Int32) -> () $Proxy.name("BlockConnected");
    blockDisconnected @4 (context :Proxy.Context, block :Data, height :Int32) -> () $Proxy.name("BlockDisconnected");
