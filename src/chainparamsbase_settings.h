#ifndef CHAINPARAMSBASE_SETTINGS_H
#define CHAINPARAMSBASE_SETTINGS_H
...
using SignetseednodeSetting = common::Setting<
    "-signetseednode", std::optional<std::vector<std::string>>, {.legacy = true, .disallow_negation = true},
...
using SignetchallengeSetting = common::Setting<
    "-signetchallenge", std::optional<std::vector<std::string>>, {.legacy = true, .disallow_negation = true},
...
using TestactivationheightSetting = common::Setting<
    "-testactivationheight=name@height.", std::vector<std::string>, {.legacy = true, .debug_only = true},
    "Set the activation height of 'name' (segwit, bip34, dersig, cltv, csv). (regtest-only)">
    ::Category<OptionsCategory::DEBUG_TEST>;

using VbparamsSetting = common::Setting<
    "-vbparams=deployment:start:end[:min_activation_height]", std::optional<std::vector<std::string>>, {.legacy = true, .debug_only = true},
