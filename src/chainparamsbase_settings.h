...
using SignetseednodeSetting = common::Setting<
    "-signetseednode", std::vector<std::string>, {.legacy = true, .disallow_negation = true},
...
using SignetchallengeSetting = common::Setting<
    "-signetchallenge", std::vector<std::string>, {.legacy = true, .disallow_negation = true},
...
using VbparamsSetting = common::Setting<
    "-vbparams=deployment:start:end[:min_activation_height]", std::vector<std::string>, {.legacy = true, .debug_only = true},
