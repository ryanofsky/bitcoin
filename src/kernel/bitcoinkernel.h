 ...
 * manager's current time, which can be overridden for testing via
 * @ref btck_chainstate_manager_set_mock_time.
 *
 * @param[in] chainstate_manager        Non-null.
 ...
 */
BITCOINKERNEL_API int BITCOINKERNEL_WARN_UNUSED_RESULT btck_chainstate_manager_set_mock_time(
    btck_ChainstateManager* chainstate_manager,
 ...
 * the chainstate manager's current time, which can be overridden for testing
 * via @ref btck_chainstate_manager_set_mock_time.
 *
 * @param[in] chainstate_manager Non-null.
