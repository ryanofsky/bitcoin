#ifndef BITCOIN_TX_SETTINGS_H
#define BITCOIN_TX_SETTINGS_H
...
using CreateSetting = common::Setting<
    "-create", bool, {.legacy = true},
    "Create new, empty TX.">;

using JsonSetting = common::Setting<
    "-json", bool, {.legacy = true},
    "Select JSON output">;

using TxidSetting = common::Setting<
    "-txid", bool, {.legacy = true},
    "Output only the hex-encoded transaction id of the resultant transaction.">;

using DelinSetting = common::Setting<
    "delin=N", std::optional<char>, {.legacy = true},
    "Delete input N from TX">
    ::Category<OptionsCategory::COMMANDS>;

using DeloutSetting = common::Setting<
    "delout=N", std::optional<char>, {.legacy = true},
    "Delete output N from TX">
    ::Category<OptionsCategory::COMMANDS>;

using InSetting = common::Setting<
    "in=TXID:VOUT(:SEQUENCE_NUMBER)", std::optional<char>, {.legacy = true},
    "Add input to TX">
    ::Category<OptionsCategory::COMMANDS>;

using LocktimeSetting = common::Setting<
    "locktime=N", std::optional<char>, {.legacy = true},
    "Set TX lock time to N">
    ::Category<OptionsCategory::COMMANDS>;

using NversionSetting = common::Setting<
    "nversion=N", std::optional<char>, {.legacy = true},
    "Set TX version to N">
    ::Category<OptionsCategory::COMMANDS>;

using OutaddrSetting = common::Setting<
    "outaddr=VALUE:ADDRESS", std::optional<char>, {.legacy = true},
    "Add address-based output to TX">
    ::Category<OptionsCategory::COMMANDS>;

using OutdataSetting = common::Setting<
    "outdata=[VALUE:]DATA", std::optional<char>, {.legacy = true},
    "Add data-based output to TX">
    ::Category<OptionsCategory::COMMANDS>;

using OutmultisigSetting = common::Setting<
    "outmultisig=VALUE:REQUIRED:PUBKEYS:PUBKEY1:PUBKEY2:....[:FLAGS]", std::optional<char>, {.legacy = true},
...
using OutpubkeySetting = common::Setting<
    "outpubkey=VALUE:PUBKEY[:FLAGS]", std::optional<char>, {.legacy = true},
...
using OutscriptSetting = common::Setting<
    "outscript=VALUE:SCRIPT[:FLAGS]", std::optional<char>, {.legacy = true},
...
using ReplaceableSetting = common::Setting<
    "replaceable(=N)", std::optional<char>, {.legacy = true},
...
using SignSetting = common::Setting<
    "sign=SIGHASH-FLAGS", std::optional<char>, {.legacy = true},
...
using LoadSetting = common::Setting<
    "load=NAME:FILENAME", std::optional<char>, {.legacy = true},
    "Load JSON file FILENAME into register NAME">
    ::Category<OptionsCategory::REGISTER_COMMANDS>;

using SetSetting = common::Setting<
    "set=NAME:JSON-STRING", std::optional<char>, {.legacy = true},
    "Set register NAME to given JSON-STRING">
    ::Category<OptionsCategory::REGISTER_COMMANDS>;

#endif // BITCOIN_TX_SETTINGS_H
