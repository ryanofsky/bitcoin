...
BlockFilterIndex::BlockFilterIndex(std::unique_ptr<interfaces::Chain> chain, BCLog::Logger& logger, BlockFilterType filter_type,
                          ...
                          size_t n_cache_size, bool f_memory, bool f_wipe)
{
    auto result = g_filter_indexes.emplace(std::piecewise_construct,
                                           ...
                                           std::forward_as_tuple(make_chain(), logger, filter_type,
