...
#include <cstdint>
#include <functional>
||||||| parent of af621131fc5 (Remove direct index -> node dependency)
#include <cstdint>
=======
>>>>>>> af621131fc5 (Remove direct index -> node dependency)
#include <memory>
#include <optional>
#include <stdexcept>
#include <string>
...
||||||| parent of d0e4e845335 (indexes, refactor: Move sync thread from index to node)
    AssertLockHeld(cs_main);
...
=======
>>>>>>> d0e4e845335 (indexes, refactor: Move sync thread from index to node)
