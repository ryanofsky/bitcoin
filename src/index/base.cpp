...
||||||| parent of 6e7a59a0e79 (Remove direct index -> node dependency)
#include <undo.h>
=======
>>>>>>> 6e7a59a0e79 (Remove direct index -> node dependency)
#include <util/fs.h>
#include <util/log.h>
...
||||||| parent of be64ba4d912 (indexes: Move sync thread from index to node)
static const CBlockIndex* NextSyncBlock(const CBlockIndex* pindex_prev, CChain& chain) EXCLUSIVE_LOCKS_REQUIRED(cs_main)
=======
bool BaseIndex::Append(const interfaces::BlockInfo& block_info)
>>>>>>> be64ba4d912 (indexes: Move sync thread from index to node)
{
<<<<<<< HEAD
