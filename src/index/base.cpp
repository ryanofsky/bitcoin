...
||||||| parent of fa5b51b56f06 (indexes, refactor: Remove SyncWithValidationInterfaceQueue call)
    SyncWithValidationInterfaceQueue();
=======
    m_chain->waitForPendingNotifications();
>>>>>>> fa5b51b56f06 (indexes, refactor: Remove SyncWithValidationInterfaceQueue call)
    return true;
}
