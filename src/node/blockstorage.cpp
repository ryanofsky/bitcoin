...
<<<<<<< HEAD
        if (OpenBlockFile(pos, /*fReadOnly=*/true).IsNull()) {
            return false;
||||||| parent of 770fe912f465 (refactor, blockstorage: Return fatal error from LoadBlockIndex)
...
=======
        if (OpenBlockFile(pos, true).IsNull()) {
            ...
            return result;
>>>>>>> 770fe912f465 (refactor, blockstorage: Return fatal error from LoadBlockIndex)
        }
    }
