...
||||||| parent of 32f601714df6 (refactor, validation: Return fatal errors from new block functions)
            LogPrintf("Warning: Could not open blocks file %s\n", fs::PathToString(path));
=======
            LogInfo("Warning: Could not open blocks file %s", fs::PathToString(path));
>>>>>>> 32f601714df6 (refactor, validation: Return fatal errors from new block functions)
        }
    }
