...
<<<<<<< HEAD
    if (!m_undo_file_seq.Flush(undo_pos_old, finalize)) {
        ...
        return false;
||||||| parent of 4be07665f235 (refactor, blockstorage: Return FlushResult from flush methods)
...
>>>>>>> 4be07665f235 (refactor, blockstorage: Return FlushResult from flush methods)
    }
    return result;
}
