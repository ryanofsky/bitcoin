...
<<<<<<< HEAD
    ...
    if (!LoadBlockIndex(snapshot_blockhash)) {
        return false;
||||||| parent of c28516be3fd (refactor, blockstorage: Return fatal error from LoadBlockIndex)
    if (!LoadBlockIndex(snapshot_blockhash)) {
        return false;
=======
    ...
    if (!result || IsInterrupted(*result)) {
        return result;
>>>>>>> c28516be3fd (refactor, blockstorage: Return fatal error from LoadBlockIndex)
    }
