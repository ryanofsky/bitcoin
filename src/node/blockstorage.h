...
||||||| parent of 71c3377ba741 (refactor, blockstorage: Return fatal error from LoadBlockIndex)
...
>>>>>>> 71c3377ba741 (refactor, blockstorage: Return fatal error from LoadBlockIndex)
        EXCLUSIVE_LOCKS_REQUIRED(::cs_main);
