...
||||||| parent of a9e09a92b8f (refactor, validation: Return fatal errors from mempool accept functions)
            auto mempool_acceptable = m_chainman.ProcessTransaction(stale_tx, /*test_accept=*/true);
=======
            auto [mempool_acceptable, flush_result] = m_chainman.ProcessTransaction(stale_tx, /*test_accept=*/true);
>>>>>>> a9e09a92b8f (refactor, validation: Return fatal errors from mempool accept functions)
