...
||||||| parent of 27485161630 (proxy, refactor: Replace EventLoop wakeup fd integers with KJ stream objects)
    KJ_ASSERT(m_wait_fd == -1);
    KJ_ASSERT(m_post_fd == -1);
...
=======
    ...
    KJ_ASSERT(m_num_clients == 0);
>>>>>>> 27485161630 (proxy, refactor: Replace EventLoop wakeup fd integers with KJ stream objects)
