...
//! this is a path to a named path pipe the parent process will write WSADuplicateSocket to.
...
//! Initialize spawned child process converting ConnectInfo string to socket
//! descriptor passed by the parent process.
