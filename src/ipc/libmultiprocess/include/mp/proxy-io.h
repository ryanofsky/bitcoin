...
<<<<<<< HEAD
    _Serve<InitInterface>(
        ...
        init,
        [] {});
||||||| parent of 6dd6e63c319 (proxy, refactor: Change ConnectStream and ServeStream to accept stream objects)
    _Serve<InitInterface>(
...
>>>>>>> 6dd6e63c319 (proxy, refactor: Change ConnectStream and ServeStream to accept stream objects)
}
