...
||||||| parent of 820c9d622a76 (multiprocess: Add capnp serialization code for bitcoin types)
...
//! Convert kj::ArrayPtr to base_blob.
>>>>>>> 820c9d622a76 (multiprocess: Add capnp serialization code for bitcoin types)
template <typename T>
