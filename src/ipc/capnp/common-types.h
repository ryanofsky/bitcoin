...
//! blob types like uint256 with begin() and end() methods iterating over bytes.
//!
...
//! called to read C++ types that can be constructed from spans of bytes. But so
//! far there hasn't been a need for this.
template <typename LocalType, typename Value, typename Output>
