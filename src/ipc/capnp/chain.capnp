...
interface Chain $Proxy.wrap("interfaces::Chain") {
    ...
    checkChainLimits @23 (context :Proxy.Context, tx :Data) -> (result :Bool);
    ...
    isReadyToBroadcast @31 (context :Proxy.Context) -> (result :Bool);
    isInitialBlockDownload @32 (context :Proxy.Context) -> (result :Bool);
    shutdownRequested @33 (context :Proxy.Context) -> (result :Bool);
    ...
    updateRwSetting @47 (context :Proxy.Context, name :Text, value :Text, write :Bool) -> (result :Bool);
    requestMempoolTransactions @48 (context :Proxy.Context, notifications :ChainNotifications) -> ();
    hasAssumedValidChain @49 (context :Proxy.Context) -> (result :Bool);
}
