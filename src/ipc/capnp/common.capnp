...
||||||| parent of caaebd660bae (multiprocess: Add capnp serialization code for bitcoin types)
=======
...
>>>>>>> caaebd660bae (multiprocess: Add capnp serialization code for bitcoin types)
