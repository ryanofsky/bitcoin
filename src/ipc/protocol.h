...
public:
    ...
    //! Handle requests a stream provided by the make_stream callback,
    ...
    //! initializes the event loop and it may not be able to create the stream
    //! before the event loop is initialized.
    //!
