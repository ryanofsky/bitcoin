...
inline SocketId StartSpawned(const SpawnConnectInfo& connect_info)
{
...
inline std::tuple<ProcessId, SocketId> SpawnProcess(SpawnConnectInfoToArgsFn&& connect_info_to_args)
{
    ProcessId pid;
