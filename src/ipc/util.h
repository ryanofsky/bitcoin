...
||||||| parent of bce09c30814 (ipc: remove compatibility shim after libmultiprocess update)
#include <mp/version.h>
#include <sys/socket.h>
...
=======
>>>>>>> bce09c30814 (ipc: remove compatibility shim after libmultiprocess update)
