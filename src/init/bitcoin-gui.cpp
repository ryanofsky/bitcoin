...
||||||| parent of e38c94ec344d (multiprocess: Make bitcoin-gui spawn a bitcoin-node process)
    node::NodeContext m_node;
=======
>>>>>>> e38c94ec344d (multiprocess: Make bitcoin-gui spawn a bitcoin-node process)
