...
||||||| parent of 8d67dc6b1ca3 (multiprocess: Make bitcoin-gui spawn a bitcoin-node process)
    node::NodeContext m_node;
=======
>>>>>>> 8d67dc6b1ca3 (multiprocess: Make bitcoin-gui spawn a bitcoin-node process)
