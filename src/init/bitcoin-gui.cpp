...
||||||| parent of e7960cc612dd (multiprocess: Make bitcoin-gui spawn a bitcoin-node process)
    const char* exeName() override { return EXE_NAME; }
    node::NodeContext m_node;
=======
    const char* exeName() override { return EXE_NAME; }
>>>>>>> e7960cc612dd (multiprocess: Make bitcoin-gui spawn a bitcoin-node process)
