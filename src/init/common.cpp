...
||||||| parent of b8e3923d4214 (scripted-diff: Add ALLOW_LIST flag to arguments retrieved with GetArgs)
...
=======
||||||| parent of 3dc90b86f753 (refactor: Fix more ALLOW_LIST arguments)
...
>>>>>>> 3dc90b86f753 (refactor: Fix more ALLOW_LIST arguments)
    argsman.AddArg("-debugexclude=<category>", "Exclude debug and trace logging for a category. Can be used in conjunction with -debug=1 to output debug and trace logging for all categories except the specified category. This option can be specified multiple times to exclude multiple categories.", ArgsManager::ALLOW_ANY | ArgsManager::ALLOW_LIST, OptionsCategory::DEBUG_TEST);
>>>>>>> b8e3923d4214 (scripted-diff: Add ALLOW_LIST flag to arguments retrieved with GetArgs)
