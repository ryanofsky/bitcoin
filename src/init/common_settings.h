#ifndef INIT_COMMON_SETTINGS_H
#define INIT_COMMON_SETTINGS_H
...
using DebugSetting = common::Setting<
    "-debug=<category>", std::optional<std::vector<std::string>>, {.legacy = true},
...
using DebugSettingBool = common::Setting<
    "-debug=<category>", std::optional<bool>, {.legacy = true}>
    ::Category<OptionsCategory::DEBUG_TEST>;

using PrinttoconsoleSetting = common::Setting<
    "-printtoconsole", std::optional<bool>, {.legacy = true},
...
using DebuglogfileSetting = common::Setting<
    "-debuglogfile=<file>", fs::path, {.legacy = true},
...
using DebuglogfileSettingDisabled = common::Setting<
    "-debuglogfile=<file>", std::optional<common::Disabled>, {.legacy = true}>;

using DebugexcludeSetting = common::Setting<
    "-debugexclude=<category>", std::vector<std::string>, {.legacy = true},
...
using LogipsSetting = common::Setting<
    "-logips", bool, {.legacy = true},
    "Include IP addresses in debug output (default: %u)">
    ::Default<DEFAULT_LOGIPS>
    ::Category<OptionsCategory::DEBUG_TEST>;

using LoglevelSetting = common::Setting<
    "-loglevel=<level>|<category>:<level>", std::optional<std::vector<std::string>>, {.legacy = true, .debug_only = true, .disallow_negation = true, .disallow_elision = true},
...
using LogsourcelocationsSetting = common::Setting<
    "-logsourcelocations", bool, {.legacy = true},
...
using LogtimemicrosSetting = common::Setting<
    "-logtimemicros", bool, {.legacy = true, .debug_only = true},
