...
using DebugSetting = common::Setting<
    "-debug=<category>", std::vector<std::string>, {.legacy = true},
...
using LoglevelSetting = common::Setting<
    "-loglevel=<level>|<category>:<level>", std::vector<std::string>, {.legacy = true, .debug_only = true, .disallow_negation = true, .disallow_elision = true},
