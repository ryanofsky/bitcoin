...
BOOST_FIXTURE_TEST_CASE(chainstatemanager, TestChain100Setup)
{
    ...
    BOOST_CHECK_EQUAL(WITH_LOCK(::cs_main, return manager.MostWorkChainstate().SnapshotBase()->GetBlockHash()), snapshot_blockhash);
    BOOST_CHECK(WITH_LOCK(::cs_main, return manager.MostWorkChainstate().SnapshotBase()));
    ...
    std::tuple<Chainstate*, Chainstate*> SetupSnapshot()
    {
        ...
        BOOST_CHECK_EQUAL(
            *chainman.ActiveChainstate().m_from_snapshot_blockhash,
            WITH_LOCK(::cs_main, return chainman.MostWorkChainstate().SnapshotBase()->GetBlockHash()));
        ...
        uint256 loaded_snapshot_blockhash{WITH_LOCK(::cs_main, return chainman.MostWorkChainstate().SnapshotBase()->GetBlockHash())};
