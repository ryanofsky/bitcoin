...
{
    BlockFilterIndex filter_index(m_logger, interfaces::MakeChain(m_node), BlockFilterType::BASIC, 1 << 20, true);
...
BOOST_FIXTURE_TEST_CASE(blockfilter_index_init_destroy, BasicTestingSetup)
{
    ...
    BOOST_CHECK(InitBlockFilterIndex([&]{ return interfaces::MakeChain(m_node); }, m_logger, BlockFilterType::BASIC, 1 << 20, true, false));
