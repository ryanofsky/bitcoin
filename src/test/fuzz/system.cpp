...
||||||| parent of bd22be02117a (common: Update ArgManager GetArg helper methods to work better with ALLOW flags)
...
>>>>>>> bd22be02117a (common: Update ArgManager GetArg helper methods to work better with ALLOW flags)
            },
            [&] {
                auto str_arg = fuzzed_data_provider.ConsumeRandomLengthString(16);
                auto str_value = fuzzed_data_provider.ConsumeRandomLengthString(16);
