...
=======
        ...
        case 0: {
            ...
            block_policy_estimator.processTx(
                ...
                fuzzed_data_provider.ConsumeIntegralInRange<CAmount>(1, std::numeric_limits<CAmount>::max() / static_cast<CAmount>(100000)), fuzzed_data_provider.ConsumeIntegralInRange<size_t>(1, std::numeric_limits<int64_t>::max()),
