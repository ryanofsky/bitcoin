...
void test_one_input(const std::vector<uint8_t>& buffer)
{
    ...
    while (fuzzed_data_provider.ConsumeBool()) {
        ...
        case 0: {
            ...
            block_policy_estimator.processTx(tx.GetHash(), fuzzed_data_provider.ConsumeIntegral<unsigned>(), fuzzed_data_provider.ConsumeIntegral<CAmount>(), fuzzed_data_provider.ConsumeIntegralInRange<size_t>(0, std::numeric_limits<int64_t>::max()), fuzzed_data_provider.ConsumeBool());
