...
void TestCoinsView(FuzzedDataProvider& fuzzed_data_provider, CCoinsView& backend_coins_view, bool is_db)
{
    ...
    LIMITED_WHILE(good_data && fuzzed_data_provider.ConsumeBool(), 10'000)
    {
        CallOneOf(
            ...
            [&] {
                static EmptyCoinsView empty_view;
                coins_view_cache.SetBackend(fuzzed_data_provider.ConsumeBool() ? backend_coins_view : empty_view);
            },
            [&] {
...
FUZZ_TARGET(coins_view, .init = initialize_coins_view)
{
    ...
    EmptyCoinsView backend_coins_view;
