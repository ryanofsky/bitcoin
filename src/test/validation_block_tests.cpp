...
||||||| parent of dab0e453435b (refactor, validation: Return fatal errors from new block functions)
...
>>>>>>> dab0e453435b (refactor, validation: Return fatal errors from new block functions)
            }
