...
using CheckaddrmanSetting = common::Setting<
    "-checkaddrman=<n>", int64_t, {.legacy = true, .debug_only = true},
...
using DatadirSettingPath = common::Setting<
    "-datadir=<dir>", fs::path, {.legacy = true}>;

using RpccookiefileSetting = common::Setting<
    "-rpccookiefile=<loc>", fs::path, {.legacy = true},
...
using Persistmempoolv1Setting = common::Setting<
    "-persistmempoolv1", bool, {.legacy = true},
...
using MaxuploadtargetSetting = common::Setting<
    "-maxuploadtarget=<n>", std::string, {.legacy = true},
...
using CheckmempoolSetting = common::Setting<
    "-checkmempool=<n>", int64_t, {.legacy = true, .debug_only = true},
...
using LimitancestorcountSetting = common::Setting<
    "-limitancestorcount=<n>", int64_t, {.legacy = true, .debug_only = true},
...
using LimitdescendantcountSetting = common::Setting<
    "-limitdescendantcount=<n>", int64_t, {.legacy = true, .debug_only = true},
...
using PrintprioritySetting = common::Setting<
    "-printpriority", bool, {.legacy = true, .debug_only = true},
...
using MempoolfullrbfSetting = common::Setting<
    "-mempoolfullrbf", bool, {.legacy = true},
...
using BlockmaxweightSetting = common::Setting<
    "-blockmaxweight=<n>", int64_t, {.legacy = true},
...
using BlockversionSetting = common::Setting<
    "-blockversion=<n>", int64_t, {.legacy = true, .debug_only = true},
