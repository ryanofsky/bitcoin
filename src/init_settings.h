...
using CheckaddrmanSetting = common::Setting<
    "-checkaddrman=<n>", std::optional<int64_t>, {.legacy = true, .debug_only = true},
...
using ConfSetting = common::Setting<
    "-conf=<file>", std::optional<std::string>, {.legacy = true},
...
using ConfSettingPath = common::Setting<
    "-conf=<file>", std::optional<fs::path>, {.legacy = true}>;

using DatadirSetting = common::Setting<
    "-datadir=<dir>", std::optional<std::string>, {.legacy = true},
    "Specify data directory">;

using DatadirSettingPath = common::Setting<
    "-datadir=<dir>", std::optional<fs::path>, {.legacy = true}>;

using RpccookiefileSetting = common::Setting<
    "-rpccookiefile=<loc>", std::optional<char>, {.legacy = true},
...
using RpcpasswordSetting = common::Setting<
    "-rpcpassword=<pw>", std::string, {.legacy = true, .sensitive = true},
    "Password for JSON-RPC connections">
    ::Category<OptionsCategory::RPC>;

using RpcportSetting = common::Setting<
    "-rpcport=<port>", std::optional<std::string>, {.legacy = true, .network_only = true},
...
using RpcportSettingInt = common::Setting<
    "-rpcport=<port>", int64_t, {.legacy = true, .network_only = true}>
    ::DefaultFn<[] { return BaseParams().RPCPort(); }>
    ::HelpFn<[](const auto& fmt, const auto& defaultBaseParams, const auto& testnetBaseParams, const auto& testnet4BaseParams, const auto& signetBaseParams, const auto& regtestBaseParams) { return strprintf(fmt, defaultBaseParams->RPCPort(), testnetBaseParams->RPCPort(), testnet4BaseParams->RPCPort(), signetBaseParams->RPCPort(), regtestBaseParams->RPCPort()); }>
    ::Category<OptionsCategory::RPC>;

using RpcuserSetting = common::Setting<
    "-rpcuser=<user>", std::string, {.legacy = true, .sensitive = true},
    "Username for JSON-RPC connections">
    ::Category<OptionsCategory::RPC>;

using DaemonSetting = common::Setting<
    "-daemon", std::optional<bool>, {.legacy = true},
...
using FastpruneSetting = common::Setting<
    "-fastprune", std::optional<bool>, {.legacy = true, .debug_only = true},
    "Use smaller block files and lower minimum prune height for testing purposes">
    ::Category<OptionsCategory::DEBUG_TEST>;

using HelpDebugSetting = common::Setting<
    "-help-debug", std::optional<char>, {.legacy = true},
    "Print help message with debugging options and exit">
    ::Category<OptionsCategory::DEBUG_TEST>;

using TestSetting = common::Setting<
    "-test=<option>", std::optional<std::vector<std::string>>, {.legacy = true, .debug_only = true},
...
using AllowignoredconfSetting = common::Setting<
    "-allowignoredconf", bool, {.legacy = true},
...
using RpccookiepermsSetting = common::Setting<
    "-rpccookieperms=<readable-by>", std::optional<std::string>, {.legacy = true},
...
using RpcauthSetting = common::Setting<
    "-rpcauth=<userpw>", std::vector<std::string>, {.legacy = true, .sensitive = true},
...
using RpcwhitelistdefaultSetting = common::Setting<
    "-rpcwhitelistdefault", bool, {.legacy = true},
    ...
    ::DefaultFn<[] { return gArgs.IsArgSet("-rpcwhitelist"); }>
    ::HelpArgs<>
    ::Category<OptionsCategory::RPC>;

using RpcwhitelistSetting = common::Setting<
    "-rpcwhitelist=<whitelist>", std::optional<std::vector<std::string>>, {.legacy = true},
...
using RpcallowipSetting = common::Setting<
    "-rpcallowip=<ip>", std::optional<std::vector<std::string>>, {.legacy = true},
...
using RpcbindSetting = common::Setting<
    "-rpcbind=<addr>[:port]", std::optional<std::vector<std::string>>, {.legacy = true, .network_only = true},
...
using RpcthreadsSetting = common::Setting<
    "-rpcthreads=<n>", int64_t, {.legacy = true},
...
using BlocknotifySetting = common::Setting<
    "-blocknotify=<cmd>", std::string, {.legacy = true},
    "Execute command when the best block changes (%s in cmd is replaced by block hash)">;

using BlockreconstructionextratxnSetting = common::Setting<
    "-blockreconstructionextratxn=<n>", std::optional<int64_t>, {.legacy = true},
...
using BlocksonlySetting = common::Setting<
    "-blocksonly", std::optional<bool>, {.legacy = true},
...
using CoinstatsindexSetting = common::Setting<
    "-coinstatsindex", bool, {.legacy = true},
...
using IncludeconfSetting = common::Setting<
    "-includeconf=<file>", std::optional<char>, {.legacy = true},
...
using LoadblockSetting = common::Setting<
    "-loadblock=<file>", std::vector<std::string>, {.legacy = true},
    "Imports blocks from external file on startup">;

using MaxmempoolSetting = common::Setting<
    "-maxmempool=<n>", std::optional<int64_t>, {.legacy = true},
...
using MaxorphantxSetting = common::Setting<
    "-maxorphantx=<n>", std::optional<int64_t>, {.legacy = true},
...
using MempoolexpirySetting = common::Setting<
    "-mempoolexpiry=<n>", std::optional<int64_t>, {.legacy = true},
    "Do not keep transactions in the mempool longer than <n> hours (default: %u)">
    ::HelpArgs<DEFAULT_MEMPOOL_EXPIRY_HOURS>;

using MinimumchainworkSetting = common::Setting<
    "-minimumchainwork=<hex>", std::optional<std::string>, {.legacy = true, .debug_only = true},
...
using PersistmempoolSetting = common::Setting<
    "-persistmempool", bool, {.legacy = true},
...
using Persistmempoolv1Setting = common::Setting<
    "-persistmempoolv1", std::optional<bool>, {.legacy = true},
...
using PruneSetting = common::Setting<
    "-prune=<n>", std::optional<int64_t>, {.legacy = true},
...
using ReindexChainstateSetting = common::Setting<
    "-reindex-chainstate", bool, {.legacy = true},
...
using SettingsSetting = common::Setting<
    "-settings=<file>", std::optional<char>, {.legacy = true},
...
using StartupnotifySetting = common::Setting<
    "-startupnotify=<cmd>", std::string, {.legacy = true},
    "Execute command on startup.">;

using ShutdownnotifySetting = common::Setting<
    "-shutdownnotify=<cmd>", std::vector<std::string>, {.legacy = true},
...
using BlockfilterindexSetting = common::Setting<
    "-blockfilterindex=<type>", std::vector<std::string>, {.legacy = true},
...
using BlockfilterindexSettingStr = common::Setting<
    "-blockfilterindex=<type>", std::string, {.legacy = true}>
    ::DefaultFn<[] { return DEFAULT_BLOCKFILTERINDEX; }>
    ::HelpFn<[](const auto& fmt) { return strprintf(fmt, DEFAULT_BLOCKFILTERINDEX, ListBlockFilterTypes()); }>;

using AddnodeSetting = common::Setting<
    "-addnode=<ip>", std::vector<std::string>, {.legacy = true, .network_only = true},
...
using AsmapSetting = common::Setting<
    "-asmap=<file>", std::optional<fs::path>, {.legacy = true},
    ...
    ::HelpFn<[](const auto& fmt) { return strprintf(fmt, DEFAULT_ASMAP_FILENAME); }>
    ::Category<OptionsCategory::CONNECTION>;

using BantimeSetting = common::Setting<
    "-bantime=<n>", int64_t, {.legacy = true},
...
using BindSetting = common::Setting<
    "-bind=<addr>[:<port>][=onion]", std::optional<std::vector<std::string>>, {.legacy = true, .network_only = true},
...
using CjdnsreachableSetting = common::Setting<
    "-cjdnsreachable", std::optional<char>, {.legacy = true},
...
using ConnectSetting = common::Setting<
    "-connect=<ip>", std::optional<std::vector<std::string>>, {.legacy = true, .network_only = true},
...
using DnsseedSetting = common::Setting<
    "-dnsseed", std::optional<bool>, {.legacy = true},
...
using ExternalipSetting = common::Setting<
    "-externalip=<ip>", std::optional<std::vector<std::string>>, {.legacy = true},
    "Specify your own public address">
    ::Category<OptionsCategory::CONNECTION>;

using FixedseedsSetting = common::Setting<
    "-fixedseeds", bool, {.legacy = true},
...
using MaxreceivebufferSetting = common::Setting<
    "-maxreceivebuffer=<n>", int64_t, {.legacy = true},
...
using MaxsendbufferSetting = common::Setting<
    "-maxsendbuffer=<n>", int64_t, {.legacy = true},
...
using MaxuploadtargetSetting = common::Setting<
    "-maxuploadtarget=<n>", std::optional<std::string>, {.legacy = true},
...
using OnionSetting = common::Setting<
    "-onion=<ip:port|path>", std::string, {.legacy = true},
...
using OnionSetting2 = common::Setting<
    "-onion=<ip:port>", std::string, {.legacy = true},
...
using OnlynetSetting = common::Setting<
    "-onlynet=<net>", std::optional<std::vector<std::string>>, {.legacy = true},
...
using TxreconciliationSetting = common::Setting<
    "-txreconciliation", std::optional<bool>, {.legacy = true, .debug_only = true},
...
using PortSetting = common::Setting<
    "-port=<port>", std::optional<int64_t>, {.legacy = true, .network_only = true},
...
using ProxySetting = common::Setting<
    "-proxy=<ip:port|path>", std::optional<std::string>, {.legacy = true, .disallow_elision = true},
...
using SeednodeSetting = common::Setting<
    "-seednode=<ip>", std::optional<std::vector<std::string>>, {.legacy = true},
...
using NetworkactiveSetting = common::Setting<
    "-networkactive", bool, {.legacy = true},
...
using PeertimeoutSetting = common::Setting<
    "-peertimeout=<n>", int64_t, {.legacy = true, .debug_only = true},
...
using TorcontrolSetting = common::Setting<
    "-torcontrol=<ip>:<port>", std::string, {.legacy = true},
...
using WhitelistSetting = common::Setting<
    "-whitelist=<[permissions@]IP address or network>", std::vector<std::string>, {.legacy = true},
...
using ZmqpubhashblockSetting = common::Setting<
    "-zmqpubhashblock=<address>", std::optional<char>, {.legacy = true},
    "Enable publish hash block in <address>">
    ::Category<OptionsCategory::ZMQ>;

using ZmqpubhashtxSetting = common::Setting<
    "-zmqpubhashtx=<address>", std::optional<char>, {.legacy = true},
    "Enable publish hash transaction in <address>">
    ::Category<OptionsCategory::ZMQ>;

using ZmqpubrawblockSetting = common::Setting<
    "-zmqpubrawblock=<address>", std::optional<char>, {.legacy = true},
    "Enable publish raw block in <address>">
    ::Category<OptionsCategory::ZMQ>;

using ZmqpubrawtxSetting = common::Setting<
    "-zmqpubrawtx=<address>", std::optional<char>, {.legacy = true},
    "Enable publish raw transaction in <address>">
    ::Category<OptionsCategory::ZMQ>;

using ZmqpubsequenceSetting = common::Setting<
    "-zmqpubsequence=<address>", std::optional<char>, {.legacy = true},
    "Enable publish hash block and tx sequence in <address>">
    ::Category<OptionsCategory::ZMQ>;

using ZmqpubhashblockhwmSetting = common::Setting<
    "-zmqpubhashblockhwm=<n>", std::optional<char>, {.legacy = true},
...
using CheckblockindexSetting = common::Setting<
    "-checkblockindex", std::optional<std::string>, {.legacy = true, .debug_only = true},
...
using CheckblockindexSettingInt = common::Setting<
    "-checkblockindex", std::optional<int64_t>, {.legacy = true, .debug_only = true}>
    ::Category<OptionsCategory::DEBUG_TEST>;

using CheckmempoolSetting = common::Setting<
    "-checkmempool=<n>", std::optional<int64_t>, {.legacy = true, .debug_only = true},
...
using CheckpointsSetting = common::Setting<
    "-checkpoints", std::optional<bool>, {.legacy = true, .debug_only = true},
...
using DeprecatedrpcSetting = common::Setting<
    "-deprecatedrpc=<method>", std::vector<std::string>, {.legacy = true, .debug_only = true},
    "Allows deprecated RPC method(s) to be used">
    ::Category<OptionsCategory::DEBUG_TEST>;

using StopafterblockimportSetting = common::Setting<
    "-stopafterblockimport", bool, {.legacy = true, .debug_only = true},
...
using StopatheightSetting = common::Setting<
    "-stopatheight", std::optional<int64_t>, {.legacy = true, .debug_only = true},
...
using LimitancestorcountSetting = common::Setting<
    "-limitancestorcount=<n>", std::optional<int64_t>, {.legacy = true, .debug_only = true},
...
using LimitancestorsizeSetting = common::Setting<
    "-limitancestorsize=<n>", std::optional<int64_t>, {.legacy = true, .debug_only = true},
...
using LimitdescendantcountSetting = common::Setting<
    "-limitdescendantcount=<n>", std::optional<int64_t>, {.legacy = true, .debug_only = true},
...
using LimitdescendantsizeSetting = common::Setting<
    "-limitdescendantsize=<n>", std::optional<int64_t>, {.legacy = true, .debug_only = true},
...
using CapturemessagesSetting = common::Setting<
    "-capturemessages", std::optional<bool>, {.legacy = true, .debug_only = true},
    "Capture all P2P messages to disk">
    ::Category<OptionsCategory::DEBUG_TEST>;

using MocktimeSetting = common::Setting<
    "-mocktime=<n>", int64_t, {.legacy = true, .debug_only = true},
...
using MaxsigcachesizeSetting = common::Setting<
    "-maxsigcachesize=<n>", std::optional<int64_t>, {.legacy = true, .debug_only = true},
...
using MaxtipageSetting = common::Setting<
    "-maxtipage=<n>", std::optional<int64_t>, {.legacy = true, .debug_only = true},
...
using PrintprioritySetting = common::Setting<
    "-printpriority", std::optional<bool>, {.legacy = true, .debug_only = true},
...
using UacommentSetting = common::Setting<
    "-uacomment=<cmt>", std::vector<std::string>, {.legacy = true},
    "Append comment to the user agent string">
    ::Category<OptionsCategory::DEBUG_TEST>;

using AcceptnonstdtxnSetting = common::Setting<
    "-acceptnonstdtxn", bool, {.legacy = true, .debug_only = true},
...
using IncrementalrelayfeeSetting = common::Setting<
    "-incrementalrelayfee=<amt>", std::optional<std::string>, {.legacy = true, .debug_only = true},
...
using DustrelayfeeSetting = common::Setting<
    "-dustrelayfee=<amt>", std::optional<std::string>, {.legacy = true, .debug_only = true},
...
using AcceptstalefeeestimatesSetting = common::Setting<
    "-acceptstalefeeestimates", bool, {.legacy = true, .debug_only = true},
...
using BytespersigopSetting = common::Setting<
    "-bytespersigop", int64_t, {.legacy = true},
...
using MinrelaytxfeeSetting = common::Setting<
    "-minrelaytxfee=<amt>", std::optional<std::string>, {.legacy = true},
...
using WhitelistforcerelaySetting = common::Setting<
    "-whitelistforcerelay", bool, {.legacy = true},
...
using WhitelistrelaySetting = common::Setting<
    "-whitelistrelay", bool, {.legacy = true},
...
using BlockmaxweightSetting = common::Setting<
    "-blockmaxweight=<n>", std::optional<int64_t>, {.legacy = true},
...
using BlockmintxfeeSetting = common::Setting<
    "-blockmintxfee=<amt>", std::optional<std::string>, {.legacy = true},
...
using ServerSetting = common::Setting<
    "-server", bool, {.legacy = true},
    "Accept command line and JSON-RPC commands">
    ::Category<OptionsCategory::RPC>;

using IpcbindSetting = common::Setting<
    "-ipcbind=<address>", std::vector<std::string>, {.legacy = true},
