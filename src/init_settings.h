...
using ConfSetting = common::Setting<
    "-conf=<file>", std::string, {.legacy = true},
...
using HelpDebugSetting = common::Setting<
    "-help-debug", common::Unset, {.legacy = true},
    "Print help message with debugging options and exit">
    ::Category<OptionsCategory::DEBUG_TEST>;

using TestSetting = common::Setting<
    "-test=<option>", std::vector<std::string>, {.legacy = true, .debug_only = true},
...
using RpcwhitelistSetting = common::Setting<
    "-rpcwhitelist=<whitelist>", std::vector<std::string>, {.legacy = true},
...
using RpcallowipSetting = common::Setting<
    "-rpcallowip=<ip>", std::vector<std::string>, {.legacy = true},
...
using RpcbindSetting = common::Setting<
    "-rpcbind=<addr>[:port]", std::vector<std::string>, {.legacy = true, .network_only = true},
...
using IncludeconfSetting = common::Setting<
    "-includeconf=<file>", common::Unset, {.legacy = true},
...
using SettingsSetting = common::Setting<
    "-settings=<file>", common::Unset, {.legacy = true},
...
using AsmapSetting = common::Setting<
    "-asmap=<file>", fs::path, {.legacy = true},
...
using BindSetting = common::Setting<
    "-bind=<addr>[:<port>][=onion]", std::vector<std::string>, {.legacy = true, .network_only = true},
...
using CjdnsreachableSetting = common::Setting<
    "-cjdnsreachable", common::Unset, {.legacy = true},
...
using ConnectSetting = common::Setting<
    "-connect=<ip>", std::vector<std::string>, {.legacy = true, .network_only = true},
...
using ExternalipSetting = common::Setting<
    "-externalip=<ip>", std::vector<std::string>, {.legacy = true},
...
using OnlynetSetting = common::Setting<
    "-onlynet=<net>", std::vector<std::string>, {.legacy = true},
...
using PortSetting = common::Setting<
    "-port=<port>", int64_t, {.legacy = true, .network_only = true},
...
using ProxySetting = common::Setting<
    "-proxy=<ip:port|path>", std::string, {.legacy = true, .disallow_elision = true},
...
using ProxySetting2 = common::Setting<
    "-proxy=<ip:port>", std::string, {.legacy = true, .disallow_elision = true},
...
using SeednodeSetting = common::Setting<
    "-seednode=<ip>", std::vector<std::string>, {.legacy = true},
...
using WhitebindSetting = common::Setting<
    "-whitebind=<[permissions@]addr>", std::vector<std::string>, {.legacy = true},
...
using IncrementalrelayfeeSetting = common::Setting<
    "-incrementalrelayfee=<amt>", std::string, {.legacy = true, .debug_only = true},
...
using DustrelayfeeSetting = common::Setting<
    "-dustrelayfee=<amt>", std::string, {.legacy = true, .debug_only = true},
...
using MinrelaytxfeeSetting = common::Setting<
    "-minrelaytxfee=<amt>", std::string, {.legacy = true},
