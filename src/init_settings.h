...
using DatadirSettingPath = common::Setting<
    "-datadir=<dir>", fs::path, common::SettingOptions{.legacy = true}>;
...
using HelpDebugSetting = common::Setting<
    "-help-debug", common::Unset, common::SettingOptions{.legacy = true},
...
using SettingsSetting = common::Setting<
    "-settings=<file>", common::Unset, common::SettingOptions{.legacy = true},
