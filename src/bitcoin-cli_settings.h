...
using ConfSetting = common::Setting<
    "-conf=<file>", common::Unset, {.legacy = true},
...
using ColorSetting = common::Setting<
    "-color=<when>", std::string, {.legacy = true, .disallow_negation = true},
...
using RpccookiefileSetting = common::Setting<
    "-rpccookiefile=<loc>", common::Unset, {.legacy = true},
...
using RpcwalletSetting = common::Setting<
    "-rpcwallet=<walletname>", std::string, {.legacy = true},
