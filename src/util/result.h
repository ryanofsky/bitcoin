...
||||||| parent of 6e1dc69a1581 (refactor: Add util::Result failure values)
...
||||||| parent of cd62acaf6aea (refactor: Add util::Result multiple error and warning messages)
    //! Update this result by moving from another result object.
=======
...
>>>>>>> cd62acaf6aea (refactor: Add util::Result multiple error and warning messages)
