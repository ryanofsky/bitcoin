...
||||||| parent of 67ac15c8e8c (util: Fix ExecVp on Windows to wait for child process and return exit code)
...
>>>>>>> 67ac15c8e8c (util: Fix ExecVp on Windows to wait for child process and return exit code)
#endif
}
