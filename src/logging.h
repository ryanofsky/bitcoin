...
||||||| parent of 2d0bc18b9fae (log, refactor: Allow log macros to accept context arguments)
#define LogPrintLevel_(category, level, should_ratelimit, ...) LogPrintFormatInternal(std::source_location::current(), category, level, should_ratelimit, __VA_ARGS__)
...
>>>>>>> 2d0bc18b9fae (log, refactor: Allow log macros to accept context arguments)
    } while (0)
...
>>>>>>> 2d0bc18b9fae (log, refactor: Allow log macros to accept context arguments)
||||||| parent of cecf87c92a45 (log, refactor: Disallow category args to logging macros)
#define LogError(...) LogPrint_(BCLog::Level::Error, true, __VA_ARGS__)
#define LogWarning(...) LogPrint_(BCLog::Level::Warning, true, __VA_ARGS__)
#define LogInfo(...) LogPrint_(BCLog::Level::Info, true, __VA_ARGS__)
#define LogDebug(...) LogPrint_(BCLog::Level::Debug, false, __VA_ARGS__)
...
>>>>>>> cecf87c92a45 (log, refactor: Disallow category args to logging macros)
