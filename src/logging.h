...
namespace BCLog {
    ...
    struct Context {
        ...
        explicit Context(LogFlags category = LogFlags::ALL, Logger& logger = LogInstance()) : category{category}, logger{logger} {}
...
static inline Context GetContext(LogFlags category) { return Context{category}; }
static inline Context GetContext(std::string_view fmt) { return Context{}; }
