...
||||||| parent of 9883750ab00c (log, refactor: Allow log macros to accept context arguments)
#define LogPrintLevel_(category, level, should_ratelimit, ...) LogPrintFormatInternal(std::source_location::current(), category, level, should_ratelimit, __VA_ARGS__)
...
>>>>>>> 9883750ab00c (log, refactor: Allow log macros to accept context arguments)
    } while (0)
