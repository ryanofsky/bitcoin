...
||||||| parent of fdcf06d4bba (log, refactor: Allow log macros to accept context arguments)
template <typename... Args>
...
>>>>>>> fdcf06d4bba (log, refactor: Allow log macros to accept context arguments)
||||||| parent of e2e05d4fc51 (log, refactor: Add preprocessor workaround for MSVC)
//! Internal helper to return first arg in a __VA_ARGS__ pack.
#define FirstArg_(arg, ...) arg
=======
...
>>>>>>> e2e05d4fc51 (log, refactor: Add preprocessor workaround for MSVC)
