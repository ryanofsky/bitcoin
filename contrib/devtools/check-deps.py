...
SUPPRESS = {
    ("merkle.cpp.o", "check.cpp.o", "_Z14assertion_failRKSt15source_locationSt17basic_string_viewIcSt11char_traitsIcEE"),
    ("muhash.cpp.o", "check.cpp.o", "_Z14assertion_failRKSt15source_locationSt17basic_string_viewIcSt11char_traitsIcEE"),
      # merkle.cpp and muhash.cpp uses Assume from util/check which calls a function in Debug builds
}

# Libraries that should not be checked
SUPPRESS_LIBS = [
    ...
    # bitcoinqt library has never had its symbol dependencies checked, but they
    # could be checked in the future. Enabling checks for it now would be
    # possible, but would require suppressions for dependencies on
    # coincontrol.cpp in bitcoin_wallet, client.cpp in bitcoin_cli, and a few
    # other spurious dependencies in bitcoin_node.
    #
