...
Subset of generated source files and includes.
</td></tr></table>
...
In the meantime, the developer guide [Internal interface guidelines](developer-notes.md#internal-interface-guidelines) can be extended with more information about keeping interfaces consistent and functional and avoiding compile errors.
