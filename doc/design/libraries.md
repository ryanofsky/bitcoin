...
||||||| parent of 2d9686fa3052 (doc: Clarifiy distinction between util and common libraries in libraries.md)
...
| *libbitcoin_kernel*      | Consensus engine and support library used for validation by *libbitcoin_node* and also exposed as a [shared library](../shared-libraries.md). |
| *libbitcoinqt*           | GUI functionality used by *bitcoin-qt* and *bitcoin-gui* executables |
>>>>>>> 2d9686fa3052 (doc: Clarifiy distinction between util and common libraries in libraries.md)
