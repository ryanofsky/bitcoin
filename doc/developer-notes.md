...
to control an individual wallet. There are also more specialized interface type
like [`interfaces::Handler`](../src/interfaces/handler.h)
...
- For consistency and friendliness to code generation tools, interface method
  ...
  once in [#14635](https://github.com/bitcoin/bitcoin/pull/14635).
