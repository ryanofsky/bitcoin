...
In general, negating an option is like setting it to `0` if it a boolean or integer option, and setting it to an empty string or path or list if it is a string or path or list option.
