...
||||||| parent of 26061df6516 (test: add interface_ipc_mining.py test calling bitcoin-mine)
=======
#!/usr/bin/env python3
...
>>>>>>> 26061df6516 (test: add interface_ipc_mining.py test calling bitcoin-mine)
