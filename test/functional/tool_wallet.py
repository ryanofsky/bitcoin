...
class ToolWalletTest(BitcoinTestFramework):
    ...
    def test_invalid_tool_commands_and_args(self):
        ...
        dat = os.path.join(self.options.tmpdir, "node0", "regtest", "wallets", "nonexistent.dat", "wallet.dat")
        self.assert_raises_tool_error("Failed to load database. Data file '{}' does not exist.".format(dat), '-wallet=nonexistent.dat', 'info')
