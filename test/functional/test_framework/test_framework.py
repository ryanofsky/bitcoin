...
||||||| parent of 6645095e6ae0 (test: add interface_ipc_mining.py test calling bitcoin-mine)
            setattr(paths, attribute_name, os.getenv(env_variable_name, default=default_filename))
=======
...
>>>>>>> 6645095e6ae0 (test: add interface_ipc_mining.py test calling bitcoin-mine)
        return paths
