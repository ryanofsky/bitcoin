...
<<<<<<< HEAD
||||||| parent of fae300f159cd (test: add interface_ipc_mining.py test calling bitcoin-mine)
...
>>>>>>> fae300f159cd (test: add interface_ipc_mining.py test calling bitcoin-mine)
