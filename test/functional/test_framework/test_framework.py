...
||||||| parent of 27c6576aba5c (test: add interface_ipc_mining.py test calling bitcoin-mine)
...
=======
            ...
            "bitcoin-wallet": ("bitcoinwallet", "BITCOINWALLET"),
>>>>>>> 27c6576aba5c (test: add interface_ipc_mining.py test calling bitcoin-mine)
        }
<<<<<<< HEAD
