...
<<<<<<< HEAD
||||||| parent of 0e98e5b908df (test: Add test to make sure -noconnect disables -dnsseed and -listen by default)
        self.stop_node(0)
=======
        ...
        self.stop_node(0)
>>>>>>> 0e98e5b908df (test: Add test to make sure -noconnect disables -dnsseed and -listen by default)
