...
class ConfArgsTest(BitcoinTestFramework):
    ...
    def test_negated_config(self):
        ...
        self.nodes[0].assert_start_raises_init_error(
            ...
            expected_msg=f'Error: Data directory "{self.nodes[0].datadir_path}" contains a "bitcoin.conf" file which is ignored, because -noconf has been set to disable config reading.{os.linesep}- Set allowignoredconf=1 option to treat this condition as a warning, not an error.',
        )
