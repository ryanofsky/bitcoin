...
class WalletBackupTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        sourcePaths = [
            ...
            os.path.join(self.nodes[0].datadir, self.chain, '.', 'wallets', self.default_wallet_name, self.wallet_data_filename),
            os.path.join(self.nodes[0].datadir, self.chain, 'wallets', self.default_wallet_name, ""), # with trailing slash
            os.path.join(self.nodes[0].datadir, self.chain, 'wallets', *(filter(None, [self.default_wallet_name])))] # no trailing slash
