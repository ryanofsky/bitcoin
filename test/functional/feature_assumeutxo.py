...
||||||| parent of 7d53e103e2ec (refactor, blockstorage: Return fatal error from LoadBlockIndex)
...
>>>>>>> 7d53e103e2ec (refactor, blockstorage: Return fatal error from LoadBlockIndex)
