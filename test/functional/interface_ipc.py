...
||||||| parent of 4ab318de0cc (ipc, test: Add tests for unclean disconnect and thread busy behavior)
=======
...
>>>>>>> 4ab318de0cc (ipc, test: Add tests for unclean disconnect and thread busy behavior)
    def run_test(self):
        self.run_echo_test()
