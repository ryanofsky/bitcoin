...
<<<<<<< HEAD
        ...
        self.start_node(0)
||||||| parent of 556eba0e5ca (pr/ipc-testasync after fixes)
        except (http.client.RemoteDisconnected, BrokenPipeError, ConnectionResetError):
            pass
        node.wait_until_stopped(expected_ret_code=(-11, -6, 1, 66), expected_stderr=re.compile(r"\S"))
        self.start_node(0)
=======
>>>>>>> 556eba0e5ca (pr/ipc-testasync after fixes)
    ...
    def run_thread_busy_test(self):
        ...
        async def async_routine():
            ...
            with node.assert_debug_log(expected_msgs=["IPC server send response"]):
