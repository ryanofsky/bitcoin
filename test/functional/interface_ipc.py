...
||||||| parent of 1f68d3136ae (ipc, test: Add tests for unclean disconnect and thread busy behavior)
=======
...
>>>>>>> 1f68d3136ae (ipc, test: Add tests for unclean disconnect and thread busy behavior)
    def run_test(self):
        self.run_echo_test()
