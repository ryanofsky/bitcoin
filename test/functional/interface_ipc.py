...
class IPCInterfaceTest(BitcoinTestFramework):
    ...
    def run_unclean_disconnect_test(self):
        ...
        node.wait_until_stopped(expected_ret_code=(-6,66), expected_stderr="bitcoin-node: ipc/libmultiprocess/include/mp/proxy.h:59: EventLoop &mp::EventLoopRef::operator*() const: Assertion `m_loop' failed.")
        self.start_node(0)
