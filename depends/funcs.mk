...
# .tar file named after the directory path (with dots and slashes collapsed and
# replaced by dashes) that will be created from the directory.
$(if $($(1)_file_name),,$(if $($(1)_local_dir),$(eval $(1)_file_name:=$(subst $(null) $(null),-,$(strip $(subst ., ,$(subst /, ,$($(1)_local_dir))))).tar)))
